...
def build_summary_prompt(md_income: str, md_balance: str, period: str, trim: bool = True) -> Dict[str, str]:
    ...
    system_msg = (
        ...
        "Your output must always include, as the final section, a summary of all legal spend."
    )
    ...
    user_parts = [
        ...
        "2. Commentary on the **3–5 largest expense categories** for the month.\n"
        ...
        "7. You must comment on legal fees and legal spend (or the absence of it).\n"
        "8. Always place the **Legal Spend Summary** as the final section of the output.\n\n"
